...
function buildSystemPrompt(): string {
  return [
    ...
    '"channel":"EMAIL|SMS|WHATSAPP|BOTH|EMAIL_WHATSAPP","urgency":"LOW|MEDIUM|HIGH|CRITICAL","reason":"<short human reason>",',
    '"confidence":0.0-1.0,"suggestedFollowUpHours":number}',
    "Rules:",
    "- Low risk, small balance -> SEND_REMINDER (EMAIL or WHATSAPP if phone available).",
    "- Medium risk or previously reminded once -> CREATE_PAYMENT_LINK (EMAIL or WHATSAPP).",
    ...
    "- CRITICAL urgency: extremely high risk, large balance, or compliance issue.",
    "Channel selection:",
    "- Prefer WHATSAPP if customer phone number is available and WhatsApp is configured.",
    "- Use EMAIL_WHATSAPP for high-value invoices to maximize reach.",
    "- Use EMAIL only when no phone number is available.",
