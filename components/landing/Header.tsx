      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          <Button
            ...
            variant="ghost"
            size="sm"
            className="hidden sm:flex text-[#596778] hover:text-[#102033] text-sm md:text-base"
          >
          ...
          <Button
            ...
            variant="ghost"
            size="sm"
            className="hidden sm:flex text-[#596778] hover:text-[#8B5CF6] text-sm md:text-base"
          >
